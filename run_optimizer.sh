...
# Compile the program
# g++ -o main_const_pulse_optimizer main_const_pulse_optimizer.cpp
g++ main_const_pulse_optimizer.cpp -Idlib/dlib -std=c++17 -O2 -o optimizer

echo "Compilation finished."

./main_const_pulse_optimizer.exe > optimizer_test.txt
